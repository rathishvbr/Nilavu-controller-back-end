export default Ember.Component.extend({
  ...
  mouseEnter() {
    if (this.get('notification.autoClear')) {
      ...
      this.notificationMessages.pauseAutoClear(this.get('notification'));
    }
  },
  ...
  mouseLeave() {
    if (this.get('notification.autoClear')) {
      ...
      this.notificationMessages.setupAutoClear(this.get('notification'));
    }
  },
  ...
  actions: {
    removeNotification() {
      this.notificationMessages.removeNotification(this.get('notification'));
    }
  }
});
