...
export default Ember.Controller.extend(ModalFunctionality, {
    ...
    actions: {
        ...
        destroy() {
          ...
          Nilavu.ajax('/b/'+this.get('bucketName'), {
              data: {
              ...
              if (result.success) {
                  self.notificationMessages.success(I18n.t('bucket.object_destroy_success'));
                  ...
                  self.send("closeModal");
                  self.notificationMessages.error(I18n.t('bucket.object_destroy_error'));
              }
          });
        },
